...
There is a problem with this agent in that is **blindly** runs any code that you send it. There are no checks or balances in the code that's either sent or run. 
